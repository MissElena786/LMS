...
function AdminDashboard() {
    ...
    console.log(allPayments, monthlySalesRecord, allUsersCount, subscribedCount)
        ...
        datasets: [
            {
                ...
                data: [1200,3000, 3500, 4000, 4500, 5000, 5500, 1500, 1800, 2000, 2500,  6000] ,
                backgroundColor: ["red"],
                borderColor: ["white"],
                borderWidth: 2
            }
    ...
    const chartOptions = {
        ...
        plugins: {
            legend: {
                ...
                position: 'top',
                labels: {
                    fontColor: 'white' // Set font color here
                }
            }
        }
    };
    ...
    const load = async ()=>{
       ...
       const pay =  await dispatch(getPaymentRecord())
          console.log(pay)
    }
                ...
                <div className="grid grid-cols-2 gap-5 m-auto mx-10">
                    ...
                    <div className="flex flex-col items-center gap-10 p-5 shadow-lg rounded-md">
                        <div className="h-80 w-full relative">
                            <Bar  className="absolute bottom-0 h-80 w-full" data={salesData}  options={chartOptions}/>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow-md">
                                <div className="flex flex-col items-center">
                                    ...
                                    {/* <h3 className="text-4xl font-bold">{ allPayments ? allPayments : "20"}</h3> */}
                            ...
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow-md">
                                <div className="flex flex-col items-center">
                                    ...
                                    <h3 className="text-4xl font-bold">{allPayments * 499}</h3>
                                </div>
